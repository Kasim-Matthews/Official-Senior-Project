...
const update = async (req, res) => {
    ...
    if (typeof Comments != "string" && typeof RecievedDate != "string" && typeof Total != "number" && typeof Partner != "number" && typeof Items != "object" && typeof Location != "string" && typeof id != "string") {
        res.sendStatus(400)
        res.end();
        return;
    }
