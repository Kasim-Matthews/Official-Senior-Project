...
function AddDistribution(){
    ...
    const [formData, setFormData] = React.useState(
        ...
        const handleSubmit = async (e) => {
          ...
          let current = await Axios.post("https://diaper-bank-inventory-management-system.onrender.com/distribution/find_q", {ItemLocationFK: IL_response.data[0].ItemLocation_id})
