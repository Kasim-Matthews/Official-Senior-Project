...
function ViewDonationSite() {
    ...
    useEffect(() => {
        Axios.get(`${process.env.REACT_APP_BACKEND_URL}/donationsite/${id}/view`).then((response) => {
            if (response.data.status === 'complete') {
                        ...
                        {intakeList.map((val) => {
                            return (
                                <TableRow>
                                    ...
                                    <TableCell>
                                        <Button variant="outlined" onClick={() => handleView(val.Intake_id)}>View Details</Button>
                                    </TableCell>
                                </TableRow>
                            )
                        })}
