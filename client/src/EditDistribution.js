    ...
    const [partners, setPartners] = React.useState([])
        ...
        function handleChange(event){
          ...
          function handleSubmit(e){
            ...
            Axios.put(`http://localhost:3306/distribution/${id}/update`, {Comments: formData.Comments, Status: formData.status, DeliveryMethod: formData.DeliveryMethod, RequestDate: formData.RequestDate, CompletedDate: formData.CompletedDate, Partner_id:formData.Partner},{
              headers: {
